...
namespace Restaurant_Site.Migrations
{
    ...
    [Migration("20240509072946_ChangeMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Restaurant_Site.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5c8f637e-6547-4038-b237-f6a6b8d21654"),
                            Description = "gushtin",
                            DishType = 0,
                        ...
                        new
                        {
                            Id = new Guid("dcdb5e3a-f8dc-48b5-8843-635e03570ec6"),
            ...
            modelBuilder.Entity("Restaurant_Site.Models.Table", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("53c4a838-6166-4756-9229-ebb173b80718"),
                            Capacity = "1"
                        });
                });
            ...
            modelBuilder.Entity("Restaurant_Site.Models.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e41ecb0c-ca5e-4aa4-a4b6-e9aef45c8c57"),
                            Address = "Dushanbe",
            ...
            modelBuilder.Entity("Restaurant_Site.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("55c98a29-3f79-4518-b3a2-3749fe564de2"),
                            Address = "Asht",
                        ...
                        new
                        {
                            Id = new Guid("0983a0f6-25e0-4b30-a792-28de31e5a180"),
                            Address = "Khujand",
            ...
            modelBuilder.Entity("Restaurant_Site.Models.Product", b =>
                {
                    b.HasOne("Restaurant_Site.Models.Order", "Holder")
                        .WithMany("products")
